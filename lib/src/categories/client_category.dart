...
class ClientCategory implements IClientCategory {
  ...
  Future reportChampSelectStarted(int userPosition, QueueType queueType, bool bansPlanned, int enemiesCount, List<Role> alliesRoles,
      List<int> availableChampions) async {
    final ChampSelectParameters parameters = ChampSelectParameters(userPosition, queueType, bansPlanned, enemiesCount, alliesRoles, availableChampions);
    /* <auto-generated-safe-area> Code within tag borders shouldn't cause incorrect behavior and will be preserved. */
    /* 	TODO: Add parameters validation */
    /* </auto-generated-safe-area> */
  ...
  Future reportActionRequested(DateTime requestedAt, bool isAllyAction, ValueRange actorsRange, ActionType type) async {
    final ActionRequestedParameters parameters = ActionRequestedParameters(requestedAt, isAllyAction, actorsRange, type);
    /* <auto-generated-safe-area> Code within tag borders shouldn't cause incorrect behavior and will be preserved. */
    /* 	TODO: Add parameters validation */
    /* </auto-generated-safe-area> */
  ...
  @override
  Future reportActionCompleted(int actorPosition, bool isActorAnAlly, int? championId) async {
    final ActionCompletedParameters parameters = ActionCompletedParameters(actorPosition, isActorAnAlly, championId);
    /* <auto-generated-safe-area> Code within tag borders shouldn't cause incorrect behavior and will be preserved. */
    /* 	TODO: Add parameters validation */
    /* </auto-generated-safe-area> */
    await _api.executeWithParameters(r'client/reportActionCompleted', parameters, withAccessToken: true);
  }

  @override
  Future reportChampionHovered(int actorPosition, bool isActorAnAlly, int championId) async {
    final ChampionHoveredParameters parameters = ChampionHoveredParameters(actorPosition, isActorAnAlly, championId);
    /* <auto-generated-safe-area> Code within tag borders shouldn't cause incorrect behavior and will be preserved. */
    /* 	TODO: Add parameters validation */
    /* </auto-generated-safe-area> */
    await _api.executeWithParameters(r'client/reportChampionHovered', parameters, withAccessToken: true);
  }

  @override
  Future reportSkinChanged(int summonerPosition, int skinId) async {
    final SkinChangedParameters parameters = SkinChangedParameters(summonerPosition, skinId);
    /* <auto-generated-safe-area> Code within tag borders shouldn't cause incorrect behavior and will be preserved. */
    /* 	TODO: Add parameters validation */
    /* </auto-generated-safe-area> */
